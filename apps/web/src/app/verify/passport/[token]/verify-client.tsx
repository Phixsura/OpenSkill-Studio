...
export default function VerifyPassportClient() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))]">
      {/* Header */}
      <div className="border-b bg-[hsl(var(--card))] print:border-0">
        <div className="mx-auto max-w-4xl px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-full bg-green-100 px-3 py-1 text-sm font-medium text-green-700 print:border print:border-green-600 print:bg-white print:text-green-800">
              ✓ Verified
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        {/* Snapshot metadata */}
        <div className="mb-8 rounded-lg border bg-[hsl(var(--card))] p-6 shadow-sm print:border-gray-300 print:shadow-none">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            {snapshot.checksum && (
              <div className="sm:col-span-2">
                ...
                <p className="mt-1 break-all rounded bg-[hsl(var(--secondary))] px-3 py-2 font-mono text-xs print:bg-gray-100">
                  {snapshot.checksum}
                </p>
              </div>
            )}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {capabilities.map((cap) => (
                <div
                  ...
                  className="rounded-lg border bg-[hsl(var(--card))] p-5 shadow-sm print:border-gray-300 print:shadow-none"
                >
                  ...
                  <div className="mb-2">
                    ...
                    <div className="mt-1 h-2 overflow-hidden rounded-full bg-[hsl(var(--secondary))] print:bg-gray-200">
                      <div
                        className="h-full rounded-full bg-[hsl(var(--primary))] print:bg-gray-700"
        ...
        <div className="mt-12 text-center text-sm text-[hsl(var(--muted-foreground))]">
          ...
          <button
            ...
            className="mt-4 rounded-md border px-4 py-2 text-sm hover:bg-[hsl(var(--secondary))] print:hidden"
          >
            🖨 Print this passport
          </button>
        </div>
