...
def test_top_level_type_and_count_r440():
    ...
    _bad(
        {"requires_capabilities": caps, "recommended_packs": [{"family": "skill_pack"}]},
...
def test_capability_entry_validation_r440():
    ...
    _bad(
        {"requires_capabilities": [{"capability": "c", "features": ["f"] * 21}]}
    )  # 21 valid strings
...
def test_recommended_pack_validation_r440():
    ...
    _bad(
        {"recommended_packs": [{"family": "skill_pack", "version": "1.2"}]},
        "INVALID_VERSION_CONSTRAINT",
    )
    _bad(
        {"recommended_packs": [{"family": "skill_pack", "version": 123}]},
        "INVALID_VERSION_CONSTRAINT",
    )
