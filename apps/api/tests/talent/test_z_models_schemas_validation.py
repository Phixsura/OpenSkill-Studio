...
class TestFrozensetConstants:
    ...
    def test_opportunity_types(self):
        ...
        assert (
            "full_time" in OPPORTUNITY_TYPES
            or "fulltime" in OPPORTUNITY_TYPES
            or len(OPPORTUNITY_TYPES) > 3
        )
...
class TestCapabilitySchemas:
    ...
    def test_create_edge_valid(self):
        ...
        req = CreateEdgeRequest(
            ...
            target_id="01ZYXWVUTSRQPONMLKJIHGFEDC",
...
class TestPassportSchemas:
    ...
    def test_snapshot_verify_response_has_valid_field(self):
        ...
        assert (
            "valid" in SnapshotVerifyResponse.model_fields
            or "is_valid" in SnapshotVerifyResponse.model_fields
            or len(SnapshotVerifyResponse.model_fields) > 0
        )
