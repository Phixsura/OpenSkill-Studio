...
down_revision: str | None = "talent15a00015"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "lifecycle_status", sa.String(length=20), server_default="discovered", nullable=False
        ),
        sa.Column(
            "external_ids",
    ...
    op.create_index(
        "ix_eco_providers_lifecycle", "eco_ai_providers", ["lifecycle_status"], unique=False
    )
    op.create_table(
        "eco_external_agents",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "workflow_format", sa.String(length=20), server_default="comfyui", nullable=False
        ),
        sa.Column(
            "node_types",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_index(
        "ix_eco_ext_workflows_lifecycle",
        "eco_external_workflows",
        ["lifecycle_status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_eco_bench_suites_family", "eco_benchmark_suites", ["family", "status"], unique=False
    )
    op.create_table(
        "eco_lifecycle_transitions",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_lifecycle_entity",
        "eco_lifecycle_transitions",
        ["entity_kind", "entity_id", "created_at"],
        unique=False,
    )
    op.create_table(
        "eco_replacement_candidates",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_candidates_deprecated",
        "eco_replacement_candidates",
        ["deprecated_kind", "deprecated_id", "status"],
        unique=False,
    )
    op.create_table(
        "eco_replacement_edges",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_repl_from", "eco_replacement_edges", ["from_kind", "from_id"], unique=False
    )
    op.create_table(
        "eco_sources",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_bench_cases_suite", "eco_benchmark_cases", ["suite_id", "sort_order"], unique=False
    )
    op.create_table(
        "eco_benchmark_runs",
        sa.Column("id", sa.String(length=26), nullable=False),
        ...
        sa.Column(
            "target", postgresql.JSONB(astext_type=sa.Text()), server_default="{}", nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_eco_bench_runs_suite", "eco_benchmark_runs", ["suite_id", "created_at"], unique=False
    )
    op.create_table(
        "eco_entity_aliases",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_aliases_entity", "eco_entity_aliases", ["entity_kind", "entity_id"], unique=False
    )
    op.create_table(
        "eco_model_versions",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_model_versions_lifecycle", "eco_model_versions", ["lifecycle_status"], unique=False
    )
    op.create_index(
        "ix_eco_model_versions_sunset", "eco_model_versions", ["sunset_at"], unique=False
    )
    op.create_table(
        "eco_review_batches",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("suite_id", sa.String(length=26), nullable=False),
        sa.Column(
            "run_ids", postgresql.JSONB(astext_type=sa.Text()), server_default="[]", nullable=False
        ),
        sa.Column(
            "alias_map",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_table(
        ...
        sa.Column(
            "baseline", postgresql.JSONB(astext_type=sa.Text()), server_default="{}", nullable=False
        ),
        sa.Column(
            "candidate_metrics",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ["replacement_candidate_id"], ["eco_replacement_candidates.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("ix_eco_rollouts_status", "eco_rollout_plans", ["status"], unique=False)
    op.create_table(
        "eco_source_sync_runs",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_sync_runs_source", "eco_source_sync_runs", ["source_id", "started_at"], unique=False
    )
    op.create_table(
        "eco_benchmark_results",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_drafts_status", "eco_component_drafts", ["draft_type", "status"], unique=False
    )
    op.create_table(
        "eco_dependency_edges",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("from_kind", sa.String(length=40), nullable=False),
        sa.Column("from_id", sa.String(length=26), nullable=False),
        sa.Column("to_kind", sa.String(length=40), nullable=False),
    ...
    op.create_index(
        "ix_eco_dep_from", "eco_dependency_edges", ["from_kind", "from_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "extraction_method", sa.String(length=20), server_default="structured", nullable=False
        ),
    ...
    op.create_index(
        "ix_eco_obs_event", "eco_observations", ["event_type", "observed_at"], unique=False
    )
    op.create_index("ix_eco_obs_external_ref", "eco_observations", ["external_ref"], unique=False)
    op.create_table(
        "eco_telemetry_snapshots",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("entity_kind", sa.String(length=30), nullable=False),
        sa.Column("entity_id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_telemetry_entity",
        "eco_telemetry_snapshots",
        ["entity_kind", "entity_id", "window_end"],
        unique=False,
    )
    op.create_table(
        "eco_watchlists",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_observation_id"], ["eco_observations.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_eco_avail_entity",
        "eco_availability_records",
        ["entity_kind", "entity_id", "record_type", "observed_at"],
        unique=False,
    )
    op.create_table(
        "eco_benchmark_reviews",
        sa.Column("id", sa.String(length=26), nullable=False),
        ...
        sa.Column(
            "scores", postgresql.JSONB(astext_type=sa.Text()), server_default="{}", nullable=False
        ),
    ...
    op.create_index(
        "ix_eco_bench_reviews_batch", "eco_benchmark_reviews", ["batch_id"], unique=False
    )
    op.create_table(
        "eco_capability_mappings",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("entity_kind", sa.String(length=30), nullable=False),
        sa.Column("entity_id", sa.String(length=26), nullable=False),
        sa.Column("capability_key", sa.String(length=64), nullable=False),
        sa.Column(
            "evidence_level", sa.String(length=30), server_default="vendor_claimed", nullable=False
        ),
        sa.Column(
            "io_spec", postgresql.JSONB(astext_type=sa.Text()), server_default="{}", nullable=False
        ),
        sa.Column("confidence", sa.Numeric(precision=4, scale=3), nullable=False),
        sa.Column("source_observation_id", sa.String(length=26), nullable=True),
        sa.Column("verified_by", sa.String(length=26), nullable=True),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "entity_kind", "entity_id", "capability_key", name="uq_eco_cap_mapping"
        ),
    )
    op.create_index(
        "ix_eco_cap_mapping_entity",
        "eco_capability_mappings",
        ["entity_kind", "entity_id"],
        unique=False,
    )
    op.create_index(
        "ix_eco_cap_mapping_key", "eco_capability_mappings", ["capability_key"], unique=False
    )
    op.create_table(
        "eco_change_events",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_changes_entity",
        "eco_change_events",
        ["entity_kind", "canonical_entity_id"],
        unique=False,
    )
    op.create_index(
        "ix_eco_changes_severity", "eco_change_events", ["severity", "acknowledged"], unique=False
    )
    op.create_index(
        "ix_eco_changes_type", "eco_change_events", ["change_type", "detected_at"], unique=False
    )
    op.create_table(
        "eco_price_observations",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("observation_id", sa.String(length=26), nullable=False),
        sa.Column("entity_kind", sa.String(length=30), nullable=False),
        sa.Column("entity_id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_price_obs_entity",
        "eco_price_observations",
        ["entity_kind", "entity_id", "observed_at"],
        unique=False,
    )
    op.create_index(
        "ix_eco_price_obs_status", "eco_price_observations", ["reconciliation_status"], unique=False
    )
    op.create_table(
        "eco_resolution_candidates",
        sa.Column("id", sa.String(length=26), nullable=False),
        sa.Column("observation_id", sa.String(length=26), nullable=False),
        sa.Column("entity_kind", sa.String(length=30), nullable=False),
    ...
    op.create_index(
        "ix_eco_resolution_obs", "eco_resolution_candidates", ["observation_id"], unique=False
    )
    op.create_index(
        "ix_eco_resolution_status", "eco_resolution_candidates", ["status"], unique=False
    )
    op.create_table(
        "eco_watch_items",
        sa.Column("id", sa.String(length=26), nullable=False),
    ...
    op.create_index(
        "ix_eco_impact_root", "eco_impact_analyses", ["root_kind", "root_id"], unique=False
    )
    op.create_index(
        "ix_eco_impact_status", "eco_impact_analyses", ["status", "classification"], unique=False
    )
    op.create_table(
        "eco_impact_items",
        sa.Column("id", sa.String(length=26), nullable=False),
        ...
        sa.Column(
            "path", postgresql.JSONB(astext_type=sa.Text()), server_default="[]", nullable=False
        ),
        sa.Column(
            "active_usage",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "recommended_action", sa.String(length=40), server_default="review", nullable=False
        ),
        sa.ForeignKeyConstraint(["analysis_id"], ["eco_impact_analyses.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_eco_impact_items_analysis", "eco_impact_items", ["analysis_id"], unique=False
    )
