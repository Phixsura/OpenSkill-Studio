...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("skill_id", sa.String(26), sa.ForeignKey("skills.id", ondelete="SET NULL"), nullable=True),
        sa.Column("project_id", sa.String(26), sa.ForeignKey("projects.id", ondelete="SET NULL"), nullable=True),
