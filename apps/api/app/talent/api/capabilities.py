...
@router.get(
    "",
    response_model=CursorListResponse[CapabilityResponse],
...
@router.post(
    "/{capability_id}/edges",
    response_model=DataResponse[EdgeResponse],
    status_code=201,
...
@router.get(
    "/{capability_id}/edges",
    response_model=DataResponse[list[EdgeResponse]],
...
@router.get(
    "/mappings",
    response_model=DataResponse[list[MappingResponse]],
