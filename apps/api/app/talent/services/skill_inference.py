...
_STOP_PHRASES = frozenset({
    ...
    "qualifications", "education", "work", "team", "company",
    "role", "position", "job", "description", "years", "ability",
    "communication", "environment", "strong", "knowledge", "good",
    "excellent", "proficient", "understanding", "familiar",
    "working", "preferred", "required", "minimum", "plus",
    "etc", "including", "related", "relevant", "demonstrated",
})
...
async def infer_skills_from_text(
    ...
    *,
    ...
    if source_type not in SOURCE_TYPES:
        raise ValueError(f"Invalid source_type: {source_type}. Must be one of {sorted(SOURCE_TYPES)}")
