...
class PeerReviewService:
    ...
    async def submit_assessment(
        ...
        *,
        ...
        # The round deadline was stored but never enforced — assessments
        # could be submitted indefinitely after it passed.
        if rnd.deadline is not None and datetime.now(UTC) > rnd.deadline:
            raise AppError("DEADLINE_PASSED", "Assessment deadline has passed", 422)
